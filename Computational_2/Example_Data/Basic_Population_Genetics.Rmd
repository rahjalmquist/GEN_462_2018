...
What if you wanted to compare Fst values for each population against each other population? You might want to do this if you want to find populations that may be more highly differentiated from others. NEEDS A GENIND OBJECT!
```{r}
