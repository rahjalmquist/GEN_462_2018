...
What if you wanted to compare Fst values for each population against each other population? You might want to do this if you want to find populations that may be more highly differentiated from others.
```{r}
pairwise <- pairwise.fst(nancycats, res.type = "matrix") #make a matrix comparing every population with every other population
pairwise
```
...
Your **HOMEWORK** can be found in the Computational_2 folder in Assignment_2. It will be due at 5pm on Thursday, September 20th. As before, please do not wait until the last minute to attempt your homework or ask for help! 
